...
public class MainController {
	...
	public @ResponseBody boolean addNewBook (@RequestParam int ownerID
			, @RequestParam String author, @RequestParam int rating, @RequestParam String title
			, @RequestParam String cover, @RequestParam double longitude, @RequestParam double latitude) {

		User userToModify = userRepository.findByUserID(ownerID);
		...
		bookToAdd.setCover(cover);
		bookToAdd.setLongitude(longitude);
		bookToAdd.setLatitude(latitude);
		bookRepository.save(bookToAdd);
		//userToModify.addBook(bookToAdd);
		userToModify.getBooks().add(bookToAdd);
	...
	public @ResponseBody Iterable<Book> searchBooks(@RequestParam String title, @RequestParam int userID) {
		Iterable<Book> matchedBooksIterable = bookRepository.findByTitleContainingIgnoreCase(title);
	...
	public @ResponseBody String updateBook(@RequestParam int bookID, @RequestParam int ownerID
		, @RequestParam String title, @RequestParam String author, @RequestParam String cover
	...
	public @ResponseBody boolean  deleteBook(@RequestParam int bookID) {
		...
		if(bookToDelete != null) {
			User userToModify = userRepository.findByUserID(bookToDelete.getOwnerID());
			List<Book> usersBooks = userToModify.getBooks();
	...
	// private methods that are used in computing distance between a book and a user
	// methods are taken from stackoverflow.com
